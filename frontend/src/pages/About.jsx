        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <img src="https://via.placeholder.com/150" alt="Dr. Smith" className="w-32 h-32 rounded-full mx-auto mb-4" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <img src="https://via.placeholder.com/150" alt="Dr. Johnson" className="w-32 h-32 rounded-full mx-auto mb-4" />
            ...
            <div className="bg-white p-6 rounded-lg shadow-md text-center">
              <img src="https://via.placeholder.com/150" alt="Nurse Lisa" className="w-32 h-32 rounded-full mx-auto mb-4" />
        ...
        <section className="mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white p-4 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/300x200" alt="Before/After 1" className="w-full h-48 object-cover rounded" />
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/300x200" alt="Before/After 2" className="w-full h-48 object-cover rounded" />
            </div>
            <div className="bg-white p-4 rounded-lg shadow-md">
              <img src="https://via.placeholder.com/300x200" alt="Before/After 3" className="w-full h-48 object-cover rounded" />
            </div>
          </div>
        </section>
